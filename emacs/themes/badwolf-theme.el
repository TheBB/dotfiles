...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face ((t (:foreground ,bwc-lightgravel :italic t :slant italic))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,bwc-lightgravel :italic t :slant italic))))
