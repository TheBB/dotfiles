...
call HL('CursorLine',   '', '', 'none')
call HL('CursorColumn', '', 'm4')
call HL('ColorColumn',  '', 'darkroast')

call HL('MatchParen', 'dalespale', '', 'bold')

call HL('NonText',    'm5', '')
call HL('SpecialKey', 'm5', '')
...
" }}}
" Gutter {{{
" call HL('LineNr',     '', s:gutter)
" call HL('SignColumn', '', s:gutter)
" call HL('FoldColumn', '', s:gutter)
" }}}
" Cursor {{{
...
call HL('Todo',           'snow', '', 'bold')
call HL('SpecialComment', 'snow', '', 'bold')
...
" }}}
" Diffs {{{
call HL('DiffDelete', 'coal', '')
" call HL('DiffAdd',    '',     '')
" call HL('DiffChange', '',     '')
call HL('DiffText',   'snow', '', 'bold')
" }}}
" Spelling {{{
if has("spell")
...
" CtrlP {{{
    ...
    " the matched pattern
    call HL('CtrlPMatch', 'orange', '', 'none')

    " the line prefix '>' in the match window
    call HL('CtrlPLinePre', 'deepgravel', '', 'none')

    " the prompt’s base
    call HL('CtrlPPrtBase', 'deepgravel', '', 'none')

    " the prompt’s text
    call HL('CtrlPPrtText', 'plain', '', 'none')
...
call HL('EasyMotionTarget', 'tardis',     '', 'bold')
call HL('EasyMotionShade',  'deepgravel', '')
...
" HTML {{{
" Punctuation
call HL('htmlTag',    'darkroast', '', 'none')
call HL('htmlEndTag', 'darkroast', '', 'none')
